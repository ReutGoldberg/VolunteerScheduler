...
export const Navbar : React.FC = () => {
  ...
  return (
    ...
    >
        <Box sx={{width: '80%'}}>
            <ButtonGroup size="large" variant="text" aria-label="text button group" fullWidth={true}>
                {/* <Button color={"secondary"} onClick={handleLogOut}> <LogoutIcon color={"secondary"}/>  Log out </Button> */}
                <Button onClick={handlePersonalEventsCalendar}>Personal events calendar</Button>
                <Button onClick={handleGeneralEventsCalendar}>General events calendar</Button>
